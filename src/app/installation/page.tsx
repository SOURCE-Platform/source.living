...
export default function InstallationPage() {
  const category = findCategoryBySlug("installation");

  if (!category) {
    throw new Error("Installation category definition is missing.");
  }
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-12 px-6 py-16 sm:px-12 lg:px-20">
      <header className="space-y-3">
        ...
        <p className="text-base leading-relaxed text-muted-foreground sm:text-lg">
          Installation coordinates deployment teams and robotics that bring SOURCE hardware and software into real spaces.
        </p>
      </header>
