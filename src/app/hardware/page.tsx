...
const category = findCategoryBySlug("hardware");

if (!category) {
  throw new Error("Hardware category definition is missing.");
}
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-12 px-6 py-16 sm:px-12 lg:px-20">
      <header className="space-y-3">
        ...
        <p className="text-base leading-relaxed text-muted-foreground sm:text-lg">
          Hardware spans the physical layer of SOURCE experiences, from ambient displays to compute hubs and structural
          infrastructure.
        </p>
      </header>
